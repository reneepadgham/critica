...
var postsLocal = [  
  ...
  {  
	...
	setTimeout(function(){
		$.each(postsLocal, function(i,v){
			var container = $('<div/>');
			$("#recent_posts_container").append(container);
			container.loadTemplate($("#post_template"), v, {paged:true, elemPerPage:5, append:true});
		});
	}, 100);
...
// $.get('https://api.critica.io/pub/threads?limit=5', function(data, status, jqXHR){
// 	if(jqXHR.status === 200 && data.status === 'ok') {
// 		//var posts = JSON.parse(postsLocal);
// 		$.each(data.result, function(i,v){
// 			v.link = "https://app.critica.io/thread/" + v.thread_id;
// 			var container = $('<div class="articlerow"/>');
// 			$("#recent_posts_container").append(container);
// 			container.loadTemplate($("#post_template"), v);

// 			//Limit the number of posts, for now
// 			if (i > 4) {
// 				return false;
// 			}
// 		});
